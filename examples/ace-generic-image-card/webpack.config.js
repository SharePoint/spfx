...
const bundles = [
  {
    "bundleName": "ace-image-adaptive-card-extension",
    "components": [
      {
        "entrypoint": "./src/adaptiveCardExtensions/aceImage/AceImageAdaptiveCardExtension.ts",
        "manifest": "./src/adaptiveCardExtensions/aceImage/AceImageAdaptiveCardExtension.manifest.json"
      }
    ]
  }
];
const localization = {
  "AceImageAdaptiveCardExtensionStrings": "src/adaptiveCardExtensions/aceImage/loc/{locale}.resjson"
};
