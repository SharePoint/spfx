...
const bundles = [
  {
    "bundleName": "react-field-customizer-field-customizer",
    "components": [
      {
        "entrypoint": "./src/extensions/reactFieldCustomizer/ReactFieldCustomizerFieldCustomizer.ts",
        "manifest": "./src/extensions/reactFieldCustomizer/ReactFieldCustomizerFieldCustomizer.manifest.json"
      }
    ]
  }
];
const localization = {
  "ReactFieldCustomizerFieldCustomizerStrings": "src/extensions/reactFieldCustomizer/loc/{locale}.resjson"
};
