...
const bundles = [
  {
    "bundleName": "no-framework-web-part-web-part",
    "components": [
      {
        "entrypoint": "./src/webparts/noFrameworkWebPart/NoFrameworkWebPartWebPart.ts",
        "manifest": "./src/webparts/noFrameworkWebPart/NoFrameworkWebPartWebPart.manifest.json"
      }
    ]
  }
];
const localization = {
  "NoFrameworkWebPartWebPartStrings": "src/webparts/noFrameworkWebPart/loc/{locale}.resjson"
};
