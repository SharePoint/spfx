...
import type { INoFrameworkCopilotComponentProperties } from './NoFrameworkProperties';

import styles from './NoFrameworkCopilotComponent.module.scss';
import welcomeDark from './assets/welcome-dark.png';
import welcomeLight from './assets/welcome-light.png';

import * as strings from 'NoFrameworkCopilotComponentStrings';
...
export default class NoFrameworkCopilotComponent extends BaseCopilotComponent<INoFrameworkCopilotComponentProperties> {
  protected render(): void {
    ...
    const rootClass: string = `${styles.noFramework} ${isDarkTheme ? styles.dark : ''}`;
