...
const bundles = [
  {
    "bundleName": "no-framework-form-customizer-form-customizer",
    "components": [
      {
        "entrypoint": "./src/extensions/noFrameworkFormCustomizer/NoFrameworkFormCustomizerFormCustomizer.ts",
        "manifest": "./src/extensions/noFrameworkFormCustomizer/NoFrameworkFormCustomizerFormCustomizer.manifest.json"
      }
    ]
  }
];
const localization = {
  "NoFrameworkFormCustomizerFormCustomizerStrings": "src/extensions/noFrameworkFormCustomizer/loc/{locale}.resjson"
};
