...
const bundles = [
  {
    "bundleName": "react-form-customizer-form-customizer",
    "components": [
      {
        "entrypoint": "./src/extensions/reactFormCustomizer/ReactFormCustomizerFormCustomizer.ts",
        "manifest": "./src/extensions/reactFormCustomizer/ReactFormCustomizerFormCustomizer.manifest.json"
      }
    ]
  }
];
const localization = {
  "ReactFormCustomizerFormCustomizerStrings": "src/extensions/reactFormCustomizer/loc/{locale}.resjson"
};
