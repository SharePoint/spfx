...
const bundles = [
  {
    "bundleName": "<%= componentNameHyphenCase %>-adaptive-card-extension",
    "components": [
      {
        "entrypoint": "./src/adaptiveCardExtensions/<%= componentNameCamelCase %>/<%= componentNameCapitalCase %>AdaptiveCardExtension.ts",
        "manifest": "./src/adaptiveCardExtensions/<%= componentNameCamelCase %>/<%= componentNameCapitalCase %>AdaptiveCardExtension.manifest.json"
      }
    ]
  }
];
const localization = {
  "<%= componentNameCapitalCase %>AdaptiveCardExtensionStrings": "src/adaptiveCardExtensions/<%= componentNameCamelCase %>/loc/{locale}.resjson"
};
