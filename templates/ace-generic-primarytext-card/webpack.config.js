...
const bundles = [
  {
    "bundleName": "ace-primary-text-adaptive-card-extension",
    "components": [
      {
        "entrypoint": "./src/adaptiveCardExtensions/acePrimaryText/AcePrimaryTextAdaptiveCardExtension.ts",
        "manifest": "./src/adaptiveCardExtensions/acePrimaryText/AcePrimaryTextAdaptiveCardExtension.manifest.json"
      }
    ]
  }
];
const localization = {
  "AcePrimaryTextAdaptiveCardExtensionStrings": "src/adaptiveCardExtensions/acePrimaryText/loc/{locale}.resjson"
};
