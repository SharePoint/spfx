...
const bundles = [
  {
    "bundleName": "ace-basic-adaptive-card-extension",
    "components": [
      {
        "entrypoint": "./src/adaptiveCardExtensions/aceBasic/AceBasicAdaptiveCardExtension.ts",
        "manifest": "./src/adaptiveCardExtensions/aceBasic/AceBasicAdaptiveCardExtension.manifest.json"
      }
    ]
  }
];
const localization = {
  "AceBasicAdaptiveCardExtensionStrings": "src/adaptiveCardExtensions/aceBasic/loc/{locale}.resjson"
};
