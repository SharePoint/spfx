...
const bundles = [
  {
    "bundleName": "react-web-part-web-part",
    "components": [
      {
        "entrypoint": "./src/webparts/reactWebPart/ReactWebPartWebPart.ts",
        "manifest": "./src/webparts/reactWebPart/ReactWebPartWebPart.manifest.json"
      }
    ]
  }
];
const localization = {
  "ReactWebPartWebPartStrings": "src/webparts/reactWebPart/loc/{locale}.resjson"
};
