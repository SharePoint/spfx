...
- Use the correct variable case: `componentName.allCaps` for string IDs, `componentName.hyphen` for localization keys, `componentName.pascal` for class names, `componentName.camel` for file/folder names
