...
const bundles = [
  {
    "bundleName": "list-view-command-set-command-set",
    "components": [
      {
        "entrypoint": "./src/extensions/listViewCommandSet/ListViewCommandSetCommandSet.ts",
        "manifest": "./src/extensions/listViewCommandSet/ListViewCommandSetCommandSet.manifest.json"
      }
    ]
  }
];
const localization = {
  "ListViewCommandSetCommandSetStrings": "src/extensions/listViewCommandSet/loc/{locale}.resjson"
};
