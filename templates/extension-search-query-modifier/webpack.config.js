...
const bundles = [
  {
    "bundleName": "search-query-modifier-search-query-modifier",
    "components": [
      {
        "entrypoint": "./src/extensions/searchQueryModifier/SearchQueryModifierSearchQueryModifier.ts",
        "manifest": "./src/extensions/searchQueryModifier/SearchQueryModifierSearchQueryModifier.manifest.json"
      }
    ]
  }
];
const localization = {
  "SearchQueryModifierSearchQueryModifierStrings": "src/extensions/searchQueryModifier/loc/{locale}.resjson"
};
