...
const bundles = [
  {
    "bundleName": "minimal-field-customizer-field-customizer",
    "components": [
      {
        "entrypoint": "./src/extensions/minimalFieldCustomizer/MinimalFieldCustomizerFieldCustomizer.ts",
        "manifest": "./src/extensions/minimalFieldCustomizer/MinimalFieldCustomizerFieldCustomizer.manifest.json"
      }
    ]
  }
];
const localization = {
  "MinimalFieldCustomizerFieldCustomizerStrings": "src/extensions/minimalFieldCustomizer/loc/{locale}.resjson"
};
