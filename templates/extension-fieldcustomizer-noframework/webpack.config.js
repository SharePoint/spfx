...
const bundles = [
  {
    "bundleName": "no-framework-field-customizer-field-customizer",
    "components": [
      {
        "entrypoint": "./src/extensions/noFrameworkFieldCustomizer/NoFrameworkFieldCustomizerFieldCustomizer.ts",
        "manifest": "./src/extensions/noFrameworkFieldCustomizer/NoFrameworkFieldCustomizerFieldCustomizer.manifest.json"
      }
    ]
  }
];
const localization = {
  "NoFrameworkFieldCustomizerFieldCustomizerStrings": "src/extensions/noFrameworkFieldCustomizer/loc/{locale}.resjson"
};
