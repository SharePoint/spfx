...
const bundles = [
  {
    "bundleName": "minimal-web-part-web-part",
    "components": [
      {
        "entrypoint": "./src/webparts/minimalWebPart/MinimalWebPartWebPart.ts",
        "manifest": "./src/webparts/minimalWebPart/MinimalWebPartWebPart.manifest.json"
      }
    ]
  }
];
const localization = {
  "MinimalWebPartWebPartStrings": "src/webparts/minimalWebPart/loc/{locale}.resjson"
};
