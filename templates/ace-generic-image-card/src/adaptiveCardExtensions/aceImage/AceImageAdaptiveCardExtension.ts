...
const CARD_VIEW_REGISTRY_ID: string = 'AceImage_CARD_VIEW';
export const QUICK_VIEW_REGISTRY_ID: string = 'AceImage_QUICK_VIEW';
...
> {
  ...
  protected loadPropertyPaneResources(): Promise<void> {
    return import(
      /* webpackChunkName: 'AceImage-property-pane'*/
